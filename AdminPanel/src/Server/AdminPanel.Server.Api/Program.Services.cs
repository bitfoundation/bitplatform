...
using AdminPanel.Server.Api.Controllers;
using AdminPanel.Server.Api.Models.Identity;
using AdminPanel.Server.Api.Services.Identity;
...
public static partial class Program
{
    ...
    private static void AddSwaggerGen(WebApplicationBuilder builder)
    {
        ...
        {
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "AdminPanel.Server.Api.xml"), includeControllerXmlComments: true);
