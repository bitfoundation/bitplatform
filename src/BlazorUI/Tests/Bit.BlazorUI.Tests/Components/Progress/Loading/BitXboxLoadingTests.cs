...
[TestClass]
public class BitXboxLoadingTests : BunitTestContext
{
    [TestMethod]
    public void BitXboxLoadingShouldRenderStructure()
    {
        var component = RenderComponent<BitXboxLoading>();

        var root = component.Find(".bit-ldn");
        Assert.IsTrue(root.ClassList.Contains("bit-ldn-xbx"));
        Assert.IsTrue(root.ClassList.Contains("bit-ldn-ltp"));

        var container = component.Find(".bit-ldn-xbx-ccn");
        Assert.AreEqual(3, container.GetElementsByClassName("bit-ldn-xbx-chl").Length);
    }

    [TestMethod]
    public void BitXboxLoadingShouldRenderLabel()
    {
        var component = RenderComponent<BitXboxLoading>(parameters =>
        {
    ...
    [TestMethod]
    public void BitXboxLoadingShouldRenderLabelTemplate()
    {
        var component = RenderComponent<BitXboxLoading>(parameters =>
        {
    ...
    [TestMethod]
    public void BitXboxLoadingShouldRespectLabelPosition()
    {
        var component = RenderComponent<BitXboxLoading>(parameters =>
        {
    ...
    [TestMethod]
    public void BitXboxLoadingShouldHonorColorAndSize()
    {
        var component = RenderComponent<BitXboxLoading>(parameters =>
        {
    ...
    [TestMethod]
    public void BitXboxLoadingShouldRespectRootStyleAndClass()
    {
        var component = RenderComponent<BitXboxLoading>(parameters =>
        {
