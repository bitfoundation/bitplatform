...
[TestClass]
public class BitBouncingDotsLoadingTests : BunitTestContext
{
    [TestMethod]
    public void BitBouncingDotsLoadingShouldRenderStructure()
    {
        var component = RenderComponent<BitBouncingDotsLoading>();

        var root = component.Find(".bit-ldn");
        Assert.IsTrue(root.ClassList.Contains("bit-ldn-bnd"));
        Assert.IsTrue(root.ClassList.Contains("bit-ldn-ltp"));

        var container = component.Find(".bit-ldn-bnd-ccn");
        Assert.AreEqual(3, container.GetElementsByClassName("bit-ldn-bnd-chl").Length);
    }

    [TestMethod]
    public void BitBouncingDotsLoadingShouldRenderLabel()
    {
        var component = RenderComponent<BitBouncingDotsLoading>(parameters =>
        {
    ...
    [TestMethod]
    public void BitBouncingDotsLoadingShouldRenderLabelTemplate()
    {
        var component = RenderComponent<BitBouncingDotsLoading>(parameters =>
        {
    ...
    [TestMethod]
    public void BitBouncingDotsLoadingShouldRespectLabelPosition()
    {
        var component = RenderComponent<BitBouncingDotsLoading>(parameters =>
        {
    ...
    [TestMethod]
    public void BitBouncingDotsLoadingShouldHonorColorAndSize()
    {
        var component = RenderComponent<BitBouncingDotsLoading>(parameters =>
        {
    ...
    [TestMethod]
    public void BitBouncingDotsLoadingShouldRespectRootStyleAndClass()
    {
        var component = RenderComponent<BitBouncingDotsLoading>(parameters =>
        {
