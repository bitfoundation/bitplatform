...
[TestClass]
public class BitBarsLoadingTests : BunitTestContext
{
    [TestMethod]
    public void BitBarsLoadingShouldRenderStructure()
    {
        var component = RenderComponent<BitBarsLoading>();

        var root = component.Find(".bit-ldn");
        Assert.IsTrue(root.ClassList.Contains("bit-ldn-bar"));
        Assert.IsTrue(root.ClassList.Contains("bit-ldn-ltp"));

        var container = component.Find(".bit-ldn-bar-ccn");
        Assert.AreEqual(3, container.GetElementsByClassName("bit-ldn-bar-chl").Length);
    }

    [TestMethod]
    public void BitBarsLoadingShouldRenderLabel()
    {
        var component = RenderComponent<BitBarsLoading>(parameters =>
        {
    ...
    [TestMethod]
    public void BitBarsLoadingShouldRenderLabelTemplate()
    {
        var component = RenderComponent<BitBarsLoading>(parameters =>
        {
    ...
    [TestMethod]
    public void BitBarsLoadingShouldRespectLabelPosition()
    {
        var component = RenderComponent<BitBarsLoading>(parameters =>
        {
    ...
    [TestMethod]
    public void BitBarsLoadingShouldHonorColorAndSize()
    {
        var component = RenderComponent<BitBarsLoading>(parameters =>
        {
    ...
    [TestMethod]
    public void BitBarsLoadingShouldRespectRootStyleAndClass()
    {
        var component = RenderComponent<BitBarsLoading>(parameters =>
        {
