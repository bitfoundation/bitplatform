...
/// </para>
/// <para>
/// Only the prose pages go through it. A component's API and its samples are read out of the
/// assembly and the demo sources instead, where they are already structured and where rendering
/// would have thrown them back into HTML for this to undo.
/// </para>
/// </summary>
