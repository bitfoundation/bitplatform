...
namespace Bit.BlazorUI.Demo.Api.Startup;
...
public static class Services
{
    public static void Add(IServiceCollection services)
    {
        ...
        services.AddScoped(c =>
        {
            ...
            // Using this registration + registrations provided in Program.cs/Startup.cs of Bit.BlazorUI.Demo.Web project,
            // you can inject HttpClient and call Bit.BlazorUI.Demo.Api api controllers in blazor pages.
