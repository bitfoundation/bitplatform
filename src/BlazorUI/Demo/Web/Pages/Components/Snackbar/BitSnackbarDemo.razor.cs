...
namespace Bit.BlazorUI.Demo.Web.Pages.Components.Snackbar;
...
public partial class BitSnackbarDemo
{
    private readonly List<ComponentParameter> componentParameters = new()
    {
        ...
        {
            Name = "Type",
            Type = "BitSnackbarType",
            DefaultValue = "BitSnackbarType.Info",
            Description = "The type of Snackbar to show.",
            LinkType = LinkType.Link,
            Href = "snackbar-type-enum"
        },
        new ComponentParameter()
        {
            Name = "TitleTemplate",
