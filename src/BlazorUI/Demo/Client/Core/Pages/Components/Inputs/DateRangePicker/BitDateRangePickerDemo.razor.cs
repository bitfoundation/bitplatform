...
BitDateRangePicker ShowTimePicker=""true""
                   Classes=""@(new() { Root = ""custom-root"",
                                      ...
                                      StartTimePickerIncreaseHourButton = ""custom-increase-btn"",
                                      StartTimePickerIncreaseMinuteButton = ""custom-increase-btn"",
                                      StartTimePickerDecreaseHourButton = ""custom-decrease-btn"",
                                      StartTimePickerDecreaseMinuteButton = ""custom-decrease-btn"",
                                      EndTimePickerIncreaseHourButton = ""custom-increase-btn"",
                                      EndTimePickerIncreaseMinuteButton = ""custom-increase-btn"",
                                      EndTimePickerDecreaseHourButton = ""custom-decrease-btn"",
                                      EndTimePickerDecreaseMinuteButton = ""custom-decrease-btn"" })"" />";
