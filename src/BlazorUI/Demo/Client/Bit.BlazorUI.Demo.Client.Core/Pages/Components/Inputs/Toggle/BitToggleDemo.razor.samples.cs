...
<div style=""--bit-Toggle-checked-background: var(--bit-clr-suc); --bit-Toggle-checked-hover-background: var(--bit-clr-suc-hover); --bit-Toggle-label-font-weight: 400; --bit-Toggle-gap: 1rem;"">
