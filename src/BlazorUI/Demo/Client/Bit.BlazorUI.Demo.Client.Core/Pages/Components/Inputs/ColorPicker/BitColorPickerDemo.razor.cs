    ...
    [
        ...
        new()
        {
            ...
            [
                ...
                new() { Name = "HexRgbModeLabel", Type = "string", DefaultValue = "HEX & RGB", Description = "What the inputs mode switch calls the HexRgb set of fields." },
                new() { Name = "HexModeLabel", Type = "string", DefaultValue = "HEX", Description = "What the inputs mode switch calls the Hex set of fields." },
                new() { Name = "RgbModeLabel", Type = "string", DefaultValue = "RGB", Description = "What the inputs mode switch calls the Rgb set of fields." },
                new() { Name = "HslModeLabel", Type = "string", DefaultValue = "HSL", Description = "What the inputs mode switch calls the Hsl set of fields." },
                new() { Name = "HsvModeLabel", Type = "string", DefaultValue = "HSV", Description = "What the inputs mode switch calls the Hsv set of fields." },
                new() { Name = "InputsModeFormat", Type = "string", DefaultValue = "Color inputs: {0}", Description = "The tooltip of the inputs mode switch. {0} the name of the current mode, which is the matching ...ModeLabel." },
                new() { Name = "InputsModeSwitchFormat", Type = "string", DefaultValue = "Color inputs: {0}. Switch to the next set.", Description = "The accessible name of the inputs mode switch, which says what pressing it will do as well. {0} the name of the current mode." },
