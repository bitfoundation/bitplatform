...
public partial class BitSplitterDemo
{
    ...
    [
        ...
        new()
        {
            ...
            Type = "BitIconInfo?",
            DefaultValue = "null",
            Description = "The icon for the BitSplitter gutter using BitIconInfo for external icon library support. Takes precedence over GutterIcon when both are set.",
        ...
        new()
        {
            ...
            Type = "string?",
            DefaultValue = "null",
            Description = "The name of the built-in Fluent UI icon to render in the BitSplitter gutter. Ignored when Icon is also set.",
            LinkType = LinkType.Link,
