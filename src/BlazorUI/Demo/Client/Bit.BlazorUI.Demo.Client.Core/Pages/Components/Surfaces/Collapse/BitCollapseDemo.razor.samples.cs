...
<BitButton OnClick=""OnExpandCollapseClick"">@(expanded ? ""Collapse"" : ""Expand"")</BitButton>
...
<BitButton OnClick=""OnExpandCollapseRtlClick"">@(expandedRtl ? ""بستن"" : ""باز کردن"")</BitButton>
