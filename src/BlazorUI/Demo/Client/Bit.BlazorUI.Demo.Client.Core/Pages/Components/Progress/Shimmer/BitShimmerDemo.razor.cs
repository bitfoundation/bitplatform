...
public partial class BitShimmerDemo
{
    ...
    [
        ...
        new()
        {
            ...
            Type = "BitColor?",
            DefaultValue = "null",
            Description = "The background color of the container of the shimmer, which is the resting color of the placeholder the animation plays over.",
            LinkType = LinkType.Link,
            Href = "#color-enum"
        },
        new()
        ...
        new()
        {
            ...
            Type = "BitColor?",
            DefaultValue = "null",
            Description = "The color of the animated part of the shimmer, over the resting Background of the placeholder.",
            LinkType = LinkType.Link,
            Href = "#color-enum"
        },
        new()
        ...
        new()
        {
            ...
            [
               ...
               new()
               {
                   ...
                   Type = "string?",
                   DefaultValue = "null",
                   Description = "Custom CSS classes/styles for the shimmer of the BitShimmer, which is the animated part inside each wrapper."
               },
            ]
        }
    ];
    ...
    [
        new()
        {
            ...
            [
                ...
                {
                    Name= "None",
                    Description="No animation at all: the placeholder is a static block.",
                    Value="3",
                }
            ]
        },
