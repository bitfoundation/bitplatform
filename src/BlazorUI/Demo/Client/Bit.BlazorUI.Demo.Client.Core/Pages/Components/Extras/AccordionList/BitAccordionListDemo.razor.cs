    ...
    [
        ...
        new()
        {
            ...
            [
                ...
                new() { Name = "Key", Type = "string?", DefaultValue = "null", Description = "A unique value to use as the key of the option. A key that is not given is generated by the list, unique among the options." },
