...
public partial class _BitChartMixedDemo
{
    ...
    private readonly BitChartOptions _dual = new()
    {
        ...
        Scales =
        {
            ["y"] = new BitChartScaleOptions { Id = "y", Type = BitChartScaleType.Linear, Placement = BitPlacement.Left, BeginAtZero = true,
                Title = new BitChartScaleTitleOptions { Display = true, Text = "Revenue ($k)" } },
            ["y2"] = new BitChartScaleOptions { Id = "y2", Type = BitChartScaleType.Linear, Placement = BitPlacement.Right, BeginAtZero = true,
