...
public partial class BitQuickGridDemo : AppComponentBase
{
    ...
    [
         new()
         {
            ...
            Description = @"Defines the child components of this instance. 
                            For example, you may define columns by adding components derived from the BitQuickGridColumnBase<TGridItem>.",
         },
         new()
         {
            Name = "Class",
        ...
        new()
         ...
         {
             Name = "Pagination",
             Type = "BitQuickGridPaginationState?",
             DefaultValue = "null",
             Description = @"Optionally links this BitQuickGrid<TGridItem> instance with a BitQuickGridPaginationState model,
                             ...
                             that displays and updates the supplied BitQuickGridPaginationState instance.",
         ...
         {
            Name = "RowTemplate",
            Type = "RenderFragment<BitQuickGridRowTemplateArgs<TGridItem>>?",
            DefaultValue = "null",
            Description = @"Optional template to customize row rendering. Receives BitQuickGridRowTemplateArgs with OriginalRow 
    ...
    [
        new()
        {
            ...
            [
                ...
                {
                    Name = "HeaderTemplate",
                    Type = "RenderFragment<BitQuickGridColumnBase<TGridItem>>?",
                    DefaultValue = "null",
                ...
                new()
                {
                    ...
                    Description = @"Indicates whether the data should be sortable by this column.
                                    The default value may vary according to the column type (for example, a BitQuickGridTemplateColumn<TGridItem>
                                    is sortable by default if any BitQuickGridTemplateColumn<TGridItem>.SortBy parameter is specified).",
                },
                new()
                {
                    Name = "IsDefaultSort",
                    Type = "BitQuickGridSortDirection?",
                    DefaultValue = "null",
        ...
        new()
        {
            Id="BitQuickGridPropertyColumn",
            Title = "BitQuickGridPropertyColumn",
        ...
        new()
        {
            ...
            [
                 ...
                 {
                    Name = "SortBy",
                    Type = "BitQuickGridSort<TGridItem>?",
                    DefaultValue = "null",
        ...
        new()
         {
            Id = "BitQuickGridPaginator",
            Title = "BitQuickGridPaginator",
            ...
            [
                ...
                {
                    Name = "SummaryFormat",
                    Type = "Func<BitQuickGridPaginationState, string>?",
                    DefaultValue = "null",
                ...
                new()
                {
                    ...
                    Type = "RenderFragment<BitQuickGridPaginationState>?",
                    DefaultValue = "null",
        ...
        new()
         {
            ...
            [
                ...
                new()
                {
                    ...
                    Type = "int?",
                    DefaultValue = "null",
                    Description = "Gets the total number of items across all pages, if known. The value will be null until an associated BitQuickGrid assigns a value after loading data.",
                },
                new()
                {
        ...
        new()
        {
            ...
            Title = "BitQuickGridRowTemplateArgs<TGridItem>",
    ...
    [
        new()
        {
             Id = "BitQuickGridAlign",
             Name = "BitQuickGridAlign",
             Description = "Describes alignment for a BitQuickGrid<TGridItem> column.",
             Items =
             [
                 new()
                 {
    ...
    private BitQuickGridPaginationState pagination2 = new() { ItemsPerPage = 7 };
    private BitQuickGridPaginationState pagination3 = new() { ItemsPerPage = 7 };
    private BitQuickGridPaginationState pagination6 = new() { ItemsPerPage = 7 };
    private BitQuickGridPaginationState pagination7 = new() { ItemsPerPage = 7 };
    ...
    protected override async Task OnInitAsync()
    {
        ...
        foodRecallProvider = async req =>
        {
            try
            {
                ...
                if (sort != default)
                {
                    ...
                    query.Add("sort", $"{sortByColumnName}:{(sort.Direction == BitQuickGridSortDirection.Ascending ? "asc" : "desc")}");
                }
        ...
        productsItemsProvider = async req =>
        {
            try
            {
                ...
                {
                    query.Add("$orderby", string.Join(", ", req.GetSortByProperties().Select(p => $"{p.PropertyName} {(p.Direction == BitQuickGridSortDirection.Ascending ? "asc" : "desc")}")));
                }
