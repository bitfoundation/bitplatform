...
public partial class BitDataGridDemo
{
    ...
    [
        ...
        new() { Name = "PagerPlacement", Type = "BitPlacement", DefaultValue = "BitPlacement.Bottom", Description = "Where the pager renders relative to the grid.", LinkType = LinkType.Link, Href = "#placement-enum" },
