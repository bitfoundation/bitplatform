...
public partial class BitDataGridDemo
{
    ...
    [
        ...
        new() { Name = "ShowExcelExport", Type = "bool", DefaultValue = "false", Description = "Renders an Excel (.xlsx) export button. The workbook is generated in-process with no external dependency; in server mode the export covers all matching rows." },
    ...
    [
        ...
        new() { Name = "ExportCsvAsync", Type = "Task", DefaultValue = "", Description = "Generates the current (filtered/sorted) data as CSV and triggers a client-side download. In server mode this exports all matching rows." },
        new() { Name = "ToCsv", Type = "string", DefaultValue = "", Description = "Builds a CSV string of the data already held by the grid (only the current page in server mode)." },
        new() { Name = "ToCsvAsync", Type = "Task<string>", DefaultValue = "", Description = "Builds a CSV string of the full dataset — in server mode it issues an OnRead request with no paging." },
        new() { Name = "ToExcelAsync", Type = "Task<byte[]>", DefaultValue = "", Description = "Generates the full (filtered/sorted) dataset as an Excel workbook (.xlsx), fetching all matching rows in server mode." },
