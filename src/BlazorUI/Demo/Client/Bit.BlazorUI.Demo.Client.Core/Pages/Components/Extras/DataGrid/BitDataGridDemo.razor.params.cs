...
public partial class BitDataGridDemo
{
    ...
    [
        ...
        new() { Name = "ShowExcelExport", Type = "bool", DefaultValue = "false", Description = "Renders an Excel (.xlsx) export button. The workbook is generated in-process with no external dependency and covers all matching rows in every data mode." },
    ...
    [
        ...
        new() { Name = "ToExcelAsync", Type = "Task<byte[]>", DefaultValue = "", Description = "Generates the full (filtered/sorted) dataset as an Excel workbook (.xlsx), covering all matching rows in every data mode (like ToCsvAsync)." },
    ...
    [
        ...
        new()
        {
            ...
            [
                ...
                new() { Name = "…", Type = "string", DefaultValue = "", Description = "Plus ~40 more: toolbar/edit button texts, filter placeholder and operator labels, boolean/enum option texts, group/detail/tree/reorder aria-labels, aggregate label formats and aria-live announcements." },
            ],
        },
    ];
