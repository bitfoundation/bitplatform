    ...
    [
        new()
        {
            ...
            [
                ...
                new() { Name = "Quote", Value = "7", Description = "Toggles a blockquote on the selected lines." },
                new() { Name = "CodeBlock", Value = "8", Description = "Wraps the current selection in a fenced code block." },
                new() { Name = "Link", Value = "9", Description = "Inserts a link or turns the current selection into a link." },
                new() { Name = "Image", Value = "10", Description = "Inserts an image or turns the current selection into an image." },
                new() { Name = "UnorderedList", Value = "11", Description = "Toggles an unordered (bullet) list on the selected lines." },
                new() { Name = "OrderedList", Value = "12", Description = "Toggles an ordered (numbered) list on the selected lines." },
                new() { Name = "TaskList", Value = "13", Description = "Toggles a task (checkbox) list on the selected lines." },
                new() { Name = "Table", Value = "14", Description = "Inserts a table template at the caret position." },
                new() { Name = "HorizontalRule", Value = "15", Description = "Inserts a horizontal rule at the caret position." },
                new() { Name = "Indent", Value = "16", Description = "Increases the indentation of the selected lines (Tab)." },
                new() { Name = "Outdent", Value = "17", Description = "Decreases the indentation of the selected lines (Shift+Tab)." },
                new() { Name = "NewLine", Value = "18", Description = "Smart newline that continues lists and quotes (Enter)." },
            ]
        },
        new()
        {
