...
public partial class BitPaginationDemo
{
    ...
    [
        ...
        new()
        {
            ...
            Type = "int",
            DefaultValue = "0",
            Description = "The number of items a page holds, which the page size selector picks. A value that is not positive falls back to the first of the PageSizeOptions, and one that is not among them is offered by the selector along with them."
        },
        new()
        {
