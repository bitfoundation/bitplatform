...
public partial class _BitTimelineCustomDemo
{
    ...
    private List<TimelineActionItem> basicCustoms1 =
    [
        new() { FirstText = "Custom 1" },
    ...
    private List<TimelineActionItem> disabledCustoms1 =
    [
        new() { FirstText = "Custom 1" },
        new() { FirstText = "Custom 2" },
    ...
    private List<TimelineActionItem> disabledCustoms2 =
    [
        new() { FirstText = "Custom 1" },
    ...
    private List<TimelineActionItem> disabledCustoms3 =
    [
...
<BitTimeline Horizontal
             Color=""BitSeverity.SevereWarning""
             Items=""iconCustoms""
             NameSelectors=""@(new() { PrimaryText = { Selector = i => i.FirstText },
                                      IconName = { Selector = i => i.Icon } })"" />
<BitTimeline Horizontal
