    ...
    private readonly List<BitNavItem> _allNavItems = new()
    {
        ...
        new()
        {
            ...
            ChildItems = new()
            {
                ...
                new() { Text = "NumberField", Url = "/components/numberfield", AdditionalUrls = new string[] { "/components/number-field", "/components/numerictextfield", "/components/numeric-text-field" }, Description = "NumberInput" },
