...
/// <summary>
/// A component that provides a user interface for <see cref="BitQuickGridPaginationState"/>.
/// </summary>
public partial class BitQuickGridPaginator : IDisposable
{
    private readonly EventCallbackSubscriber<BitQuickGridPaginationState> _totalItemCountChanged;
    ...
    /// </summary>
    [Parameter] public Func<BitQuickGridPaginationState, string>? SummaryFormat { get; set; }

    /// <summary>
    /// Optionally supplies a template for rendering the page count summary.
    /// </summary>
    [Parameter] public RenderFragment<BitQuickGridPaginationState>? SummaryTemplate { get; set; }

    /// <summary>
    /// The optional custom format for the main text of the paginator in the middle of it.
    /// </summary>
    [Parameter] public Func<BitQuickGridPaginationState, string>? TextFormat { get; set; }

    /// <summary>
    /// The optional custom template for the main text of the paginator in the middle of it.
    /// </summary>
    [Parameter] public RenderFragment<BitQuickGridPaginationState>? TextTemplate { get; set; }

    /// <summary>
    /// Specifies the associated <see cref="BitQuickGridPaginationState"/>. This parameter is required.
    /// </summary>
    [Parameter, EditorRequired] public BitQuickGridPaginationState Value { get; set; } = default!;

    /// <summary>
    /// Constructs an instance of <see cref="BitQuickGridPaginator" />.
    /// </summary>
