...
/// <summary>
/// Holds state to represent pagination in a <see cref="BitQuickGrid{TGridItem}"/>.
/// </summary>
public class BitQuickGridPaginationState
{
    ...
    /// associated <see cref="BitQuickGrid{TGridItem}"/> assigns a value after loading data.
    /// </summary>
    ...
    internal EventCallbackSubscribable<BitQuickGridPaginationState> CurrentPageItemsChanged { get; } = new();
    internal EventCallbackSubscribable<BitQuickGridPaginationState> TotalItemCountChangedSubscribable { get; } = new();
    ...
    /// <summary>
    /// Sets the current page index, and notifies any associated <see cref="BitQuickGrid{TGridItem}"/>
