...
public class BitQuickGridPropertyColumn<TGridItem, TProp> : BitQuickGridColumnBase<TGridItem>, IBitQuickGridSortBuilderColumn<TGridItem>
{
    ...
    protected override void OnParametersSet()
    {
        ...
        {
            // Auto-derive the header from the member name unless the consumer set Title explicitly. An
            // explicit flag tracks whether the current Title was auto-generated, so a user-set Title is
            // preserved even when it happens to match a member name, and a changed Property only replaces
            // a previously auto-generated header.
            if (Title is null || _titleIsAutoGenerated)
            {
