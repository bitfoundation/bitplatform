...
public class BitQuickGridPropertyColumn<TGridItem, TProp> : BitQuickGridColumnBase<TGridItem>, IBitQuickGridSortBuilderColumn<TGridItem>
{
    ...
    protected override void OnParametersSet()
    {
        ...
        {
            // The consumer supplied Title this render; respect it and forget any prior auto-generation so
            // a later Property change to a non-member expression doesn't wrongly clear the explicit value.
