...
/// <summary>
/// Represents a sort order specification used within <see cref="BitQuickGrid{TGridItem}"/>.
/// </summary>
/// <typeparam name="TGridItem">The type of data represented by each row in the grid.</typeparam>
public class BitQuickGridSort<TGridItem>
{
    ...
    internal BitQuickGridSort(Func<IQueryable<TGridItem>, bool, IOrderedQueryable<TGridItem>> first, (LambdaExpression, bool) firstExpression)
    {
        _first = first;
