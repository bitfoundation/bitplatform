...
public static class BitMarkdownEditorToolbar
{
    ...
    [
        ...
        BitMarkdownEditorToolbarItem.Separator,
        Cmd("h1", "Heading 1", BitMarkdownEditorCommand.Heading1, Icons.H1),
        Cmd("h2", "Heading 2", BitMarkdownEditorCommand.Heading2, Icons.H2),
        Cmd("h3", "Heading 3", BitMarkdownEditorCommand.Heading3, Icons.H3),
