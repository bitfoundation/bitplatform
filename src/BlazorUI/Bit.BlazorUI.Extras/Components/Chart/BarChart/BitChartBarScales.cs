...
public class BitChartBarScales
{
    ...
    /// <para>You can use any <see cref="BitChartCartesianAxis"/> but there are extended axes which contain additional properties to customize the bar chart axes.</para>
    /// </summary>
    [JsonProperty("xAxes")]
