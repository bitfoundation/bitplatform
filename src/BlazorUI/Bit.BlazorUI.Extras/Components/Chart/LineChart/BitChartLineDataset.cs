...
public class BitChartLineDataset<T> : BitChartDataset<T>
{
    ...
    /// <summary>
    /// Gets or sets the <see cref="BitChartBorderJoinStyle"/> for the lines.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the <see cref="BitChartBorderJoinStyle"/> for the lines when hovered.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the <see cref="BitChartPointStyle"/> for this dataset.
    /// </summary>
