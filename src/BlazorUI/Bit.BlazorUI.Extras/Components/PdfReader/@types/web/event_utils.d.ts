 ...
 */
declare class FirefoxEventBus extends EventBus {
 ...
 */
declare function waitOnEventOrTimeout({ target, name, delay }: WaitOnEventOrTimeoutParameters): Promise<any>;
declare namespace WaitOnType {
    let EVENT: string;
    let TIMEOUT: string;
}
