...
public class BitThemeLayout
{
    ...
    /// <summary>Multiplier for compact UI (e.g. <c>0.9</c>); combine with <see cref="BitTheme.Spacing"/>.<see cref="BitThemeSpacings.ScalingFactor"/>. Maps to <c>--bit-layout-density-scale</c>.</summary>
