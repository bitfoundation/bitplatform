...
{
    public static class BitAutoCompleteValue
    {
        //values source: https://html.spec.whatwg.org/multipage/form-control-infrastructure.html#autofill
        ...
        public static readonly string OneTimeCode = "one-time-code";
        ...
        public static readonly string Bday = "bday";
        public static readonly string BdayDay = "bday-day";
        public static readonly string BdayMonth = "bday-month";
        public static readonly string BdayYear = "bday-year";
        ...
        public static readonly string TelCountryCode = "tel-country-code";
        public static readonly string TelNational = "tel-national";
        public static readonly string TelAreaCode = "tel-area-code";
        public static readonly string TelLocal = "tel-local";
        public static readonly string TelLocalPrefix = "tel-local-prefix";
        public static readonly string TelLocalSuffix = "tel-local-suffix";
        public static readonly string TelExtension = "tel-extension";
        public static readonly string Email = "email";
        public static readonly string Impp = "impp";
    }
}
