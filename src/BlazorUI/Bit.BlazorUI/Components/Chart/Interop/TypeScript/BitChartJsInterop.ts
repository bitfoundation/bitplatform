...
class BitChartJsInterop {
    ...
    private wireUpCallbacks(config: BitChartConfiguration) {
    ...
    private wireUpOptionsOnClick(config: BitChartConfiguration) {
    ...
    private wireUpOptionsOnHover(config: BitChartConfiguration) {
        let getDefaultFunc = (type: any) => {
            let defaults = Chart.defaults[type] || Chart.defaults.global;
    ...
    private wireUpLegendOnClick(config: BitChartConfiguration) {
    ...
    private wireUpLegendOnHover(config: BitChartConfiguration) {
        let getDefaultFunc = (type: any) => {
            let chartDefaults = Chart.defaults[type] || Chart.defaults.global;
    ...
    private wireUpLegendItemFilter(config: BitChartConfiguration) {
        let getDefaultFunc = (type: any) => {
            let chartDefaults = Chart.defaults[type] || Chart.defaults.global;
    ...
    private wireUpGenerateLabels(config: BitChartConfiguration) {
        let getDefaultFunc = (type: any) => {
            let chartDefaults = Chart.defaults[type] || Chart.defaults.global;
    ...
    private wireUpTickCallback(config: BitChartConfiguration) {
