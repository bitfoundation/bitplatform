    ...
    export class Nav {
        ...
        public static install() {
            ...
            document.addEventListener('keydown', (e: KeyboardEvent) => {
                ...
                // Space and Enter are the activation keys of the chevron, which is a div with a button
                // role sitting inside the item's own anchor or button: on top of the page scrolling of
                // Space, the browser also activates that enclosing element when a key is pressed on
                // something it contains. Both defaults are cancelled here, exactly like the click of the
                // chevron is, and the toggling is left to the chevron's own handler. Outside the chevron
                // nothing is taken away: Enter keeps activating the item itself.
