...
public partial class BitCircularTimePicker : BitInputBase<TimeSpan?>
{
    ...
    /// <summary>
    /// Determines the side of the input the CircularTimePicker's icon is rendered on (default is the end side).
    /// </summary>
    /// <remarks>
    ...
    protected override void RegisterCssClasses()
    {
        ...
        ClassBuilder.Register(() => IconPlacement is BitPlacement.Start ? "bit-ctp-lic" : string.Empty);
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        ...
        try
        {
            ...
            {
                await _js.BitSwipesSetup(_calloutId, 0.25m, BitPlacement.Top, Dir is BitDir.Rtl, BitSwipeOrientation.Vertical, _dotnetObj);
