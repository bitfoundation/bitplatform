...
public class BitMenuButtonClassStyles
{
    ...
    /// </summary>
    public BitClassStylePair? Callout { get; set; }

    /// <summary>
    /// Custom CSS classes/styles for the chevron down of the BitMenuButton.
    /// </summary>
    public BitClassStylePair? ChevronDown { get; set; }
    ...
    /// </summary>
    public BitClassStylePair? ItemButton { get; set; }
