...
public partial class BitSplitButtonOption : ComponentBase, IDisposable
{
    ...
    /// </summary>
    [Parameter] public EventCallback<BitSplitButtonOption> OnClick { get; set; }
    ...
    /// </summary>
    [Parameter] public RenderFragment<BitSplitButtonOption>? Template { get; set; }
