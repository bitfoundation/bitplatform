...
public partial class BitSplitButtonList<TItem> where TItem : class
{
    ...
    private async Task ToggleCallout()
    {
        ...
        await _js.ToggleSplitButtonListCallout(obj, UniqueId.ToString(), _splitButtonId, _splitButtonCalloutId, _splitButtonOverlayId, _isCalloutOpen);
