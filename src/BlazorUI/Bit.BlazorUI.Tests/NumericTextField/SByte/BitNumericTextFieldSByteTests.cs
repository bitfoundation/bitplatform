...
public class BitNumericTextFieldSByteTests : BunitTestContext
{
    ...
    {
        var component = RenderComponent<BitNumericTextFieldSByteTest>(parameters =>
        {
    ...
    {
        var component =
            RenderComponent<BitNumericTextFieldSByteTest>(parameters => parameters.Add(p => p.Suffix, suffix));
    ...
    {
        var component = RenderComponent<BitNumericTextFieldSByteTest>();
    ...
    public void BitNumericTextFieldOnChangeTest(int inputValue)
    {
        ...
        changeArgs.Value = (sbyte)inputValue;
        input.Change((sbyte)inputValue);
        input.Blur();

        Assert.AreEqual((sbyte)inputValue, component.Instance.OnChangeEventValue);
    }
    ...
    public void BitNumericTextFieldInputShouldHaveCorrectAriaValueNow(int? ariaValueNow, string suffix)
    {
        ...
        var input = component.Find("input");
        var expectedResult = ariaValueNow is not null ? (sbyte?)ariaValueNow :
    ...
    public void BitNumericTextFieldContinuousIncrementOnMouseDownTest(int defaultValue, int step, int max, int timeout)
    {
        ...
        var expectedResult =
            (sbyte)defaultValue + (sbyte)step * (sbyte)(initialIncrementCount + continuousIncrementCount);
        incrementButton.MouseDown();
    ...
    public void BitNumericTextFieldContinuousDecrementOnMouseDownTest(int defaultValue, int step, int min, int timeout)
    {
        ...
        var expectedResult =
            (sbyte)defaultValue - (sbyte)step * (sbyte)(initialDecrementCount + continuousDecrementCount);
        incrementButton.MouseDown();
    ...
    private sbyte? Normalize(sbyte? value, int precision) =>
        value is null ? null : (sbyte?)Math.Round((double)value.Value, precision);
