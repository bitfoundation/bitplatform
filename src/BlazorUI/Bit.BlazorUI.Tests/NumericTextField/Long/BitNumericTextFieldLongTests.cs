...
public class BitNumericTextFieldLongTests : BunitTestContext
{
    ...
    public void BitNumericTextFieldContinuousIncrementOnMouseDownTest(long defaultValue, long step, long max,
        int timeout)
    {
        var component = RenderComponent<BitNumericTextField<long>>(parameters =>
        {
    ...
    public void BitNumericTextFieldContinuousDecrementOnMouseDownTest(long defaultValue, long step, long min,
        int timeout)
    {
        var component = RenderComponent<BitNumericTextField<long>>(parameters =>
        {
