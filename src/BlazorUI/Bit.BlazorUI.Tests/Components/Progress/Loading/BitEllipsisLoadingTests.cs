...
[TestClass]
public class BitEllipsisLoadingTests : BunitTestContext
{
    [TestMethod]
    public void BitEllipsisLoadingShouldRenderStructure()
    {
        var component = RenderComponent<BitEllipsisLoading>();

        var root = component.Find(".bit-ldn");
        Assert.IsTrue(root.ClassList.Contains("bit-ldn-elp"));
        Assert.IsTrue(root.ClassList.Contains("bit-ldn-ltp"));

        var container = component.Find(".bit-ldn-elp-ccn");
        Assert.AreEqual(4, container.GetElementsByClassName("bit-ldn-elp-chl").Length);
    }

    [TestMethod]
    public void BitEllipsisLoadingShouldRenderLabel()
    {
        var component = RenderComponent<BitEllipsisLoading>(parameters =>
        {
    ...
    [TestMethod]
    public void BitEllipsisLoadingShouldRenderLabelTemplate()
    {
        var component = RenderComponent<BitEllipsisLoading>(parameters =>
        {
    ...
    [TestMethod]
    public void BitEllipsisLoadingShouldRespectLabelPosition()
    {
        var component = RenderComponent<BitEllipsisLoading>(parameters =>
        {
    ...
    [TestMethod]
    public void BitEllipsisLoadingShouldHonorColorAndSize()
    {
        var component = RenderComponent<BitEllipsisLoading>(parameters =>
        {
    ...
    [TestMethod]
    public void BitEllipsisLoadingShouldRespectRootStyleAndClass()
    {
        var component = RenderComponent<BitEllipsisLoading>(parameters =>
        {
