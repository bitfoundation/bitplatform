...
[TestClass]
public class BitDualRingLoadingTests : BunitTestContext
{
    [TestMethod]
    public void BitDualRingLoadingShouldRenderStructure()
    {
        var component = RenderComponent<BitDualRingLoading>();

        var root = component.Find(".bit-ldn");
        Assert.IsTrue(root.ClassList.Contains("bit-ldn-dur"));
        Assert.IsTrue(root.ClassList.Contains("bit-ldn-ltp"));

        var container = component.Find(".bit-ldn-dur-ccn");
        Assert.IsNotNull(container);
    }

    [TestMethod]
    public void BitDualRingLoadingShouldRenderLabel()
    {
        var component = RenderComponent<BitDualRingLoading>(parameters =>
        {
    ...
    [TestMethod]
    public void BitDualRingLoadingShouldRenderLabelTemplate()
    {
        var component = RenderComponent<BitDualRingLoading>(parameters =>
        {
    ...
    [TestMethod]
    public void BitDualRingLoadingShouldRespectLabelPosition()
    {
        var component = RenderComponent<BitDualRingLoading>(parameters =>
        {
    ...
    [TestMethod]
    public void BitDualRingLoadingShouldHonorColorAndSize()
    {
        var component = RenderComponent<BitDualRingLoading>(parameters =>
        {
    ...
    [TestMethod]
    public void BitDualRingLoadingShouldRespectRootStyleAndClass()
    {
        var component = RenderComponent<BitDualRingLoading>(parameters =>
        {
