...
[TestClass]
public class BitCircleLoadingTests : BunitTestContext
{
    [TestMethod]
    public void BitCircleLoadingShouldRenderStructure()
    {
        var component = RenderComponent<BitCircleLoading>();

        var root = component.Find(".bit-ldn");
        Assert.IsTrue(root.ClassList.Contains("bit-ldn-cir"));
        Assert.IsTrue(root.ClassList.Contains("bit-ldn-ltp"));

        var container = component.Find(".bit-ldn-cir-ccn");
        Assert.AreEqual(1, container.GetElementsByClassName("bit-ldn-cir-chl").Length);
    }

    [TestMethod]
    public void BitCircleLoadingShouldRenderLabel()
    {
        var component = RenderComponent<BitCircleLoading>(parameters =>
        {
    ...
    [TestMethod]
    public void BitCircleLoadingShouldRenderLabelTemplate()
    {
        var component = RenderComponent<BitCircleLoading>(parameters =>
        {
    ...
    [TestMethod]
    public void BitCircleLoadingShouldRespectLabelPosition()
    {
        var component = RenderComponent<BitCircleLoading>(parameters =>
        {
    ...
    [TestMethod]
    public void BitCircleLoadingShouldHonorColorAndSize()
    {
        var component = RenderComponent<BitCircleLoading>(parameters =>
        {
    ...
    [TestMethod]
    public void BitCircleLoadingShouldRespectRootStyleAndClass()
    {
        var component = RenderComponent<BitCircleLoading>(parameters =>
        {
