...
[TestClass]
public class BitGridLoadingTests : BunitTestContext
{
    [TestMethod]
    public void BitGridLoadingShouldRenderStructure()
    {
        var component = RenderComponent<BitGridLoading>();

        var root = component.Find(".bit-ldn");
        Assert.IsTrue(root.ClassList.Contains("bit-ldn-grd"));
        Assert.IsTrue(root.ClassList.Contains("bit-ldn-ltp"));

        var container = component.Find(".bit-ldn-grd-ccn");
        Assert.AreEqual(9, container.GetElementsByClassName("bit-ldn-grd-chl").Length);
    }

    [TestMethod]
    public void BitGridLoadingShouldRenderLabel()
    {
        var component = RenderComponent<BitGridLoading>(parameters =>
        {
    ...
    [TestMethod]
    public void BitGridLoadingShouldRenderLabelTemplate()
    {
        var component = RenderComponent<BitGridLoading>(parameters =>
        {
    ...
    [TestMethod]
    public void BitGridLoadingShouldRespectLabelPosition()
    {
        var component = RenderComponent<BitGridLoading>(parameters =>
        {
    ...
    [TestMethod]
    public void BitGridLoadingShouldHonorColorAndSize()
    {
        var component = RenderComponent<BitGridLoading>(parameters =>
        {
    ...
    [TestMethod]
    public void BitGridLoadingShouldRespectRootStyleAndClass()
    {
        var component = RenderComponent<BitGridLoading>(parameters =>
        {
