...
public class BitImageTests : BunitTestContext
{
    ...
    public void BitImageShouldRenderExpectedElement()
    {
        ...
        component.MarkupMatches(@"<div class=""bit-img"" id:ignore><img class=""bit-img-img bit-img-por"" /></div>");
    }
    ...
    public void BitImageShouldRespectIsEnabled(bool isEnabled)
    {
        ...
        component.MarkupMatches(@$"<div class=""bit-img{cssClass}"" id:ignore><img class=""bit-img-img bit-img-por"" /></div>");
    }
    ...
    public void BitImageShouldRespectIsEnabledChangingAfterRender()
    {
        ...
        component.MarkupMatches(@"<div class=""bit-img bit-dis"" id:ignore><img class=""bit-img-img bit-img-por"" /></div>");
    }
    ...
    public void BitImageShouldRespectStyle(string style)
    {
        ...
        if (style.HasValue())
        {
            component.MarkupMatches(@$"<div style=""{style}"" class=""bit-img"" id:ignore><img class=""bit-img-img bit-img-por"" /></div>");
        }
        else
        {
            component.MarkupMatches(@"<div class=""bit-img"" id:ignore><img class=""bit-img-img bit-img-por"" /></div>");
    ...
    public void BitImageShouldRespectStyles(string rootStyle, string imageStyle)
    {
        ...
        component.MarkupMatches(@$"<div style=""{rootStyle}"" class=""bit-img"" id:ignore><img style=""{imageStyle}"" class=""bit-img-img bit-img-por"" /></div>");
    }
    ...
    public void BitImageShouldRespectClasses(string rootClass, string imageClass)
    {
        ...
        component.MarkupMatches(@$"<div class=""{rootClass} bit-img"" id:ignore><img class=""{imageClass} bit-img-img bit-img-por"" /></div>");
    }
    ...
    public void BitImageShouldRespectId(string id)
    {
        ...
        component.MarkupMatches(@$"<div id=""{expectedId}"" class=""bit-img""><img class=""bit-img-img bit-img-por"" /></div>");
    }
    ...
    public void BitImageShouldRespectDir(BitDir? dir)
    {
        ...
        if (dir.HasValue)
        {
            ...
            component.MarkupMatches(@$"<div dir=""{dir.Value.ToString().ToLower()}"" class=""bit-img{cssClass}"" id:ignore><img class=""bit-img-img bit-img-por"" /></div>");
        }
        else
        {
            component.MarkupMatches(@"<div class=""bit-img"" id:ignore><img class=""bit-img-img bit-img-por"" /></div>");
    ...
    public void BitImageShouldRespectDirChangingAfterRender()
    {
        ...
        component.MarkupMatches(@"<div dir=""ltr"" class=""bit-img"" id:ignore><img class=""bit-img-img bit-img-por"" /></div>");
    }
    ...
    public void BitImageShouldRespectVisibility(BitVisibility visibility)
    {
        ...
        component.MarkupMatches(@$"<div {styleAttribute} class=""bit-img"" id:ignore><img class=""bit-img-img bit-img-por"" /></div>");
    }
    ...
    public void BitImageShouldRespectVisibilityChangingAfterRender()
    {
        ...
        component.MarkupMatches(@"<div style=""display: none;"" class=""bit-img"" id:ignore><img class=""bit-img-img bit-img-por"" /></div>");
    }
    ...
    public void BitImageShouldRespectHtmlAttributes()
    {
        ...
        component.MarkupMatches(@"<div data-val-test=""bit"" class=""bit-img"" id:ignore><img class=""bit-img-img bit-img-por"" src=""images/bit-logo-blue.png"" /></div>");
    }
    ...
    public void BitImageShouldRespectAlt(string alt)
    {
        ...
        if (alt.HasValue())
        {
            component.MarkupMatches(@$"<div class=""bit-img"" id:ignore><img alt=""{alt}"" class=""bit-img-img bit-img-por"" /></div>");
        }
        else
        {
            component.MarkupMatches(@"<div class=""bit-img"" id:ignore><img class=""bit-img-img bit-img-por"" /></div>");
    ...
    public void BitImageShouldRespectCoverStyle(BitImageCover? coverStyle)
    {
        ...
        {
            component.MarkupMatches(@"<div class=""bit-img"" id:ignore><img class=""bit-img-lan bit-img-img"" /></div>");
        }
        else
        {
            component.MarkupMatches(@"<div class=""bit-img"" id:ignore><img class=""bit-img-por bit-img-img"" /></div>");
        }
    }
    ...
    public void BitImageShouldRespectHeight(string height)
    {
        ...
        if (height.HasValue())
        {
            ...
            component.MarkupMatches(@$"<div style=""{style}"" class=""bit-img"" id:ignore><img class=""bit-img-ihh bit-img-img bit-img-por"" /></div>");
        }
        else
        {
            component.MarkupMatches(@"<div class=""bit-img"" id:ignore><img class=""bit-img-img bit-img-por"" /></div>");
    ...
    public void BitImageShouldRespectHeightChangingAfterRender()
    {
        ...
        component.MarkupMatches(@"<div style=""height:85px"" class=""bit-img"" id:ignore><img class=""bit-img-ihh bit-img-img bit-img-por"" /></div>");
    }
    ...
    public void BitImageShouldRespectWidth(string width)
    {
        ...
        if (width.HasValue())
        {
            ...
            component.MarkupMatches(@$"<div style=""{style}"" class=""bit-img"" id:ignore><img class=""bit-img-ihw bit-img-img bit-img-por"" /></div>");
        }
        else
        {
            component.MarkupMatches(@"<div class=""bit-img"" id:ignore><img class=""bit-img-img bit-img-por"" /></div>");
    ...
    public void BitImageShouldRespectWidthChangingAfterRender()
    {
        ...
        component.MarkupMatches(@"<div style=""width:85px"" class=""bit-img"" id:ignore><img class=""bit-img-ihw bit-img-img bit-img-por"" /></div>");
    }
    ...
    public void BitImageShouldRespectImageAttributes(string attrKey, string attrValue)
    {
        ...
        component.MarkupMatches(@$"<div class=""bit-img"" id:ignore><img {attr} class=""bit-img-img bit-img-por"" /></div>");
    }
    ...
    public void BitImageShouldRespectImageFit(BitImageFit? imageFit)
    {
        ...
        component.MarkupMatches(@$"<div class=""bit-img"" id:ignore><img class=""{cssClass} bit-img-img bit-img-por"" /></div>");
    }
    ...
    public void BitImageShouldRespectHeightWidthAndImageFit(string height, string width, BitImageFit? imageFit)
    {
        ...
        if (style.Length > 0)
        {
            component.MarkupMatches(@$"<div style=""{style}"" class=""bit-img"" id:ignore><img class=""{cssClass} bit-img-img bit-img-por"" /></div>");
        }
        else
        {
            component.MarkupMatches(@$"<div class=""bit-img"" id:ignore><img class=""{cssClass} bit-img-img bit-img-por"" /></div>");
    ...
    public void BitImageShouldRespectLoading(BitImageLoading? loading)
    {
        ...
        if (loading.HasValue)
        {
            component.MarkupMatches(@$"<div class=""bit-img"" id:ignore><img loading=""{loading.ToString()!.ToLower()}"" class=""bit-img-img bit-img-por"" /></div>");
        }
        else
        {
            component.MarkupMatches(@"<div class=""bit-img"" id:ignore><img class=""bit-img-img bit-img-por"" /></div>");
    ...
    public void BitImageShouldRespectSrc(string src)
    {
        ...
        if (src.HasValue())
        {
            component.MarkupMatches(@$"<div class=""bit-img"" id:ignore><img src=""{src}"" class=""bit-img-img bit-img-por"" /></div>");
        }
        else
        {
            component.MarkupMatches(@"<div class=""bit-img"" id:ignore><img class=""bit-img-img bit-img-por"" /></div>");
    ...
    public void BitImageShouldRespectTitle(string title)
    {
        ...
        if (title.HasValue())
        {
            component.MarkupMatches(@$"<div class=""bit-img"" id:ignore><img title=""{title}"" class=""bit-img-img bit-img-por"" /></div>");
        }
        else
        {
            component.MarkupMatches(@"<div class=""bit-img"" id:ignore><img class=""bit-img-img bit-img-por"" /></div>");
