...
declare type InitializeParameters = {
    /**
...
declare function isDestArraysEqual(firstDest: any, secondDest: any): boolean;
declare function isDestHashesEqual(destHash: any, pushHash: any): boolean;
