...
public partial class BitPdfReaderLegacy : BitComponentBase
{
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        ...
        {
            string[] scripts = [
                "_content/Bit.BlazorUI.Legacy/pdf.js/pdfjs-4.7.76.js",
                "_content/Bit.BlazorUI.Legacy/pdf.js/pdfjs-4.7.76-worker.js"
            ];

            await _js.BitLegacyInitScripts(scripts, true);
