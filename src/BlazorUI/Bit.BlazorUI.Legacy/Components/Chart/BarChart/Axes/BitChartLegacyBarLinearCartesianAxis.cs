...
/// <summary>
/// Extended version of <see cref="BitChartLegacyLinearCartesianAxis"/> for use in a bar chart.
...
/// </summary>
public class BitChartLegacyBarLinearCartesianAxis : BitChartLegacyLinearCartesianAxis
{
    /// <summary>
