...
/// </summary>
public sealed class BitChartLegacyBorderJoinStyle : BitChartLegacyStringEnum
{
    /// <summary>
    /// Fills an additional triangular area between the common endpoint of connected segments, and the separate outside rectangular corners of each segment.
    /// </summary>
    public static BitChartLegacyBorderJoinStyle Bevel => new BitChartLegacyBorderJoinStyle("bevel");
    ...
    /// </summary>
    public static BitChartLegacyBorderJoinStyle Round => new BitChartLegacyBorderJoinStyle("round");
    ...
    /// </summary>
    public static BitChartLegacyBorderJoinStyle Miter => new BitChartLegacyBorderJoinStyle("miter");

    /// <summary>
    /// Creates a new instance of the <see cref="BitChartLegacyBorderJoinStyle"/> class.
    /// </summary>
    /// <param name="stringValue">The <see cref="string"/> value to set.</param>
    private BitChartLegacyBorderJoinStyle(string stringValue) : base(stringValue) { }
}
