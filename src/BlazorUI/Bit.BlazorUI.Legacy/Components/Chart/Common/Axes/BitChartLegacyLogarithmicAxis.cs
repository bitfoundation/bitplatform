...
/// </summary>
public class BitChartLegacyLogarithmicAxis : BitChartLegacyCartesianAxis<BitChartLegacyLogarithmicTicks>
{
    /// <inheritdoc/>
    public override BitChartLegacyAxisType Type => BitChartLegacyAxisType.Logarithmic;
}
