...
namespace Bit.ViewModel.Implementations
{
    ...
    /// </summary>
    public class BitPopupPageNavigationService : PopupPageNavigationService
    {
        public BitPopupPageNavigationService(IPopupNavigation popupNavigation, IContainerExtension container, IApplicationProvider applicationProvider, IPageBehaviorFactory pageBehaviorFactor, ILoggerFacade logger)
