    ...
    [
        ...
        [
            ...
            new("navigation-pipeline", "How a navigation works",
                ...
                "pipeline order phases decide commit preventive supersession cancel redirect fail closed revalidation reload preload concepts",
                typeof(PipelinePage)),
        ]),
        new("Routing",
        [
        ...
        [
            new("data-loading", "Data loading",
                "Route loaders with stale-while-revalidate caching, revalidation, reload, preloading, deferred data and error boundaries.",
                "loader cache StaleTime revalidate revalidation reload ReloadAsync IsReload preload Intent Viewport deferred BrouterAwait ErrorContent retry",
                typeof(LoadersPage)),
        ]),
        new("User experience",
        [
            ...
            new("lifecycle", "Lifecycle & keep-alive",
                "Activation, renavigation and deactivation callbacks, plus keep-alive retention with per-parameter instances and the resets that throw them away.",
                "lifecycle OnActivated OnDeactivated OnRenavigated keep-alive KeepAlive KeepAliveMax retention LRU ClearKeepAlive includeActive rebuild reset instance",
        ...
        [
            new("api", "API reference",
                ...
                typeof(ApiPage)),
            new("recipes", "Recipes",
                "Task-oriented solutions: protected areas, unsaved changes, revalidation, switching tenant, query state, breadcrumbs, keep-alive lists.",
                "recipes cookbook patterns how-to examples auth login unsaved changes breadcrumbs paging filters localization tenant impersonate reload rebuild sign-out",
                typeof(RecipesPage)),
