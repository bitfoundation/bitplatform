...
/// </summary>
/// <remarks>
/// A single <see cref="BrouteConstraint"/> instance is registered per constraint name and
...
/// </remarks>
public abstract class BrouteConstraint
{
    ...
    internal static BrouteConstraint Resolve(string template, string segment, string constraint)
    {
...
/// with the resolved <see cref="BrouteConstraint"/> instance.
/// </summary>
/// <remarks>
...
/// </remarks>
internal readonly record struct BrouteConstraintBinding(string Name, BrouteConstraint Constraint);
