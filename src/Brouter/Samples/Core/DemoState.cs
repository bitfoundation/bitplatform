...
/// <summary>
/// Scoped state shared between the sample pages and the routes declared in AppRouter - the
/// realistic pattern for a LeaveGuard that needs to know whether a page is dirty, and for keeping
/// values readable after the page that produced them has unmounted.
/// </summary>
public sealed class DemoState
{
    ...
    /// <summary>Whether the /unstable route's loader should throw (toggled from UnstablePage).</summary>
