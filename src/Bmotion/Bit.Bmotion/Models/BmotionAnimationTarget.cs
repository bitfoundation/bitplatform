...
/// Can be implicitly constructed from <see cref="BmotionAnimationProps"/>, a variant name string,
...
public sealed class BmotionAnimationTarget
{
    ...
    /// Two prop targets are equivalent when their <see cref="BmotionAnimationProps"/> values match;
