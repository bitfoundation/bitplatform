...
// an unanchored /\/mcp([/?]|$)/ would also claim a page route that merely ends in /mcp. Both
// also end on '?', or a navigation carrying a query string would miss them and be answered
// with the app shell.
