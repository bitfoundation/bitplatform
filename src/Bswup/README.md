...
- `AutoReload` (default `false`): reload automatically when an update finishes instead of showing the reload button. **Changed in v-10-6-0** - previous versions defaulted to `true`.
