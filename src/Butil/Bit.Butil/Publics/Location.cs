...
public class Location(IJSRuntime js)
{
    ...
    public async Task<string> GetHref()
        => await js.InvokeFast<string>("BitButil.location.getHref");
    /// <summary>
    ...
    public async Task SetHref(string value)
        => await js.InvokeVoidFast("BitButil.location.setHref", value);
    ...
    public async Task<string> GetProtocol()
        => await js.InvokeFast<string>("BitButil.location.getProtocol");
    /// <summary>
    ...
    public async Task SetProtocol(string value)
        => await js.InvokeVoidFast("BitButil.location.setProtocol", value);
    ...
    public async Task<string> GetHost()
        => await js.InvokeFast<string>("BitButil.location.getHost");
    /// <summary>
    ...
    public async Task SetHost(string value)
        => await js.InvokeVoidFast("BitButil.location.setHost", value);
    ...
    public async Task<string> GetHostname()
        => await js.InvokeFast<string>("BitButil.location.getHostname");
    /// <summary>
    ...
    public async Task SetHostname(string value)
        => await js.InvokeVoidFast("BitButil.location.setHostname", value);
    ...
    public async Task<string> GetPort()
        => await js.InvokeFast<string>("BitButil.location.getPort");
    /// <summary>
    ...
    public async Task SetPort(string value)
        => await js.InvokeVoidFast("BitButil.location.setPort", value);
    ...
    public async Task<string> GetPathname()
        => await js.InvokeFast<string>("BitButil.location.getPathname");
    /// <summary>
    ...
    public async Task SetPathname(string value)
        => await js.InvokeVoidFast("BitButil.location.setPathname", value);
    ...
    public async Task<string> GetSearch()
        => await js.InvokeFast<string>("BitButil.location.getSearch");
    /// <summary>
    ...
    public async Task SetSearch(string value)
        => await js.InvokeVoidFast("BitButil.location.setSearch", value);
    ...
    public async Task<string> GetHash()
        => await js.InvokeFast<string>("BitButil.location.getHash");
    /// <summary>
    ...
    public async Task SetHash(string value)
        => await js.InvokeVoidFast("BitButil.location.setHash", value);
    ...
    public async Task Assign(string url)
        => await js.InvokeVoidFast("BitButil.location.assign", url);
    ...
    public async Task Reload()
        => await js.InvokeVoidFast("BitButil.location.reload");
    ...
    public async Task Replace(string url)
        => await js.InvokeVoidFast("BitButil.location.replace", url);
}
