...
public class History(IJSRuntime js) : IDisposable
{
    ...
    /// </summary>
    public async Task<int> GetLength() => await js.HistoryGetLength();

    /// <summary>
    /// Gets default scroll restoration behavior on history navigation. This property can be either auto or manual.
    /// </summary>
    public async Task<ScrollRestoration> GetScrollRestoration() => await js.HistoryGetScrollRestoration();
    ...
    /// </summary>
    public async Task<object> GetState() => await js.HistoryGetState();
    ...
    /// </summary>
    public async Task GoBack() => await js.HistoryGoBack();
    ...
    /// </summary>
    /// <returns></returns>
    public async Task GoForward() => await js.HistoryGoForward();
    ...
    /// </summary>
    public async Task Go(int? delta = null) => await js.HistoryGo(delta);
    ...
    public async Task PushState(object? state = null, string? url = null) => await js.HistoryPushState(state, string.Empty, url);
    ...
    public async Task ReplaceState(object? state = null, string? url = null) => await js.HistoryReplaceState(state, string.Empty, url);
