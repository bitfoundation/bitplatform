...
(function (butil: any) {
    ...
    // Client Hints members there are a handful of property reads, while the parser below is a port
    // of platform.js and is the bulk of what this pair of modules weighs. Splitting them means an
    // app that only asks whether the client is mobile does not download the parser it never calls.
    butil.userAgentParser = {
        extract
    };
