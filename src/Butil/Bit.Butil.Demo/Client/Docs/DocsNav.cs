...
public static class DocsNav
{
    ...
    [
        ...
        [
            ...
            new("Navigation", "navigation", "🗺️", "The modern successor to History - read the entry list, and finally know whether you can go back.", typeof(NavigationPage)),
        ...
        [
            new("Screen", "screen", "🖥️", "Physical screen metrics, color depth and availability.", typeof(ScreenPage), ApiSupport.Partial),
            ...
            new("Performance", "performance", "⏱️", "High-resolution timing, marks, measures and entries.", typeof(PerformancePage), ApiSupport.Partial),
            new("Reporting", "reporting", "🧾", "Observe deprecation, intervention and crash reports.", typeof(ReportingPage), ApiSupport.Chromium),
            new("Console", "console", "🖨️", "The full browser console API from C#: log, table, group, time.", typeof(ConsolePage)),
        ]),
        new("DOM & Interaction",
        [
            ...
            new("PictureInPicture", "picture-in-picture", "🖼️", "Float a video in an always-on-top window outside the page.", typeof(PictureInPicturePage), ApiSupport.Broad, ApiNeeds.UserGesture),
            new("ViewTransition", "view-transition", "🎞️", "Let the browser animate between two states of the page.", typeof(ViewTransitionPage), ApiSupport.Partial),
            new("Keyboard", "keyboard", "⌨️", "App-wide keyboard shortcuts with modifier support.", typeof(KeyboardPage)),
            new("IntersectionObserver", "intersection-observer", "👁️", "Observe element visibility inside the viewport or a scroll container.", typeof(IntersectionObserverPage), ApiSupport.Broad, ApiNeeds.None,
        ...
        [
            ...
            new("CookieStore", "cookie-store", "🗄️", "The async Cookie Store API with change events.", typeof(CookieStorePage), ApiSupport.Chromium, ApiNeeds.SecureContext),
        ...
        [
            ...
            new("FileSystem", "file-system", "🗂️", "Pick real files and folders, then read and write them back.", typeof(FileSystemPage), ApiSupport.Chromium, ApiNeeds.UserGesture),
            new("Compression", "compression", "🗜️", "Gzip and deflate through the browser's native codec.", typeof(CompressionPage), ApiSupport.Broad),
        ]),
        new("Network & Workers",
        [
            new("ServiceWorker", "service-worker", "⚙️", "Register and inspect service workers.", typeof(ServiceWorkerPage), ApiSupport.Broad, ApiNeeds.SecureContext),
        ...
        [
            ...
            new("Geolocation", "geolocation", "🛰️", "Current position, watch positions and errors.", typeof(GeolocationPage), ApiSupport.Broad, ApiNeeds.SecureContext | ApiNeeds.Permission),
            ...
            new("Nfc", "nfc", "🏷️", "Read and write NDEF messages on NFC tags.", typeof(NfcPage), ApiSupport.ChromiumMobile, ApiNeeds.SecureContext | ApiNeeds.Permission | ApiNeeds.UserGesture | ApiNeeds.Experimental),
            new("WakeLock", "wake-lock", "☀️", "Keep the screen awake while your app needs it.", typeof(WakeLockPage), ApiSupport.Partial, ApiNeeds.SecureContext),
        ...
        new("Media & Speech",
        [
            new("SpeechSynthesis", "speech-synthesis", "🗣️", "Text-to-speech with voices, pitch and rate.", typeof(SpeechSynthesisPage), ApiSupport.Broad, ApiNeeds.UserGesture),
            new("SpeechRecognition", "speech-recognition", "🎙️", "Speech-to-text with interim results and events.", typeof(SpeechRecognitionPage), ApiSupport.Partial, ApiNeeds.SecureContext | ApiNeeds.Permission),
            ...
            new("MediaRecorder", "media-recorder", "⏺️", "Record a camera, microphone or screen share to a file.", typeof(MediaRecorderPage), ApiSupport.Broad, ApiNeeds.SecureContext | ApiNeeds.Permission),
            new("MediaSession", "media-session", "🎛️", "Lock-screen metadata and hardware media-key handlers.", typeof(MediaSessionPage), ApiSupport.Partial),
        ]),
    ];
