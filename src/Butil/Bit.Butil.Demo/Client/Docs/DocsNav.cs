...
public static class DocsNav
{
    ...
    [
        ...
        [
            ...
            new("Performance", "performance", "High-resolution timing, marks, measures, typed navigation/resource/long-task entries and Web Vitals.", typeof(PerformancePage), ApiSupport.Partial),
        ...
        [
            ...
            new("Css", "css", "Computed styles, CSS.supports, typed style maps, stylesheets you can edit, Houdini worklets, and highlights painted over text.", typeof(CssPage), ApiSupport.Partial, ApiNeeds.None,
                ["Css", "StyleSheetHandle", "ElementReferenceStyleMapExtensions"]),
        ...
        [
            ...
            new("StorageBuckets", "storage-buckets", "Named compartments of the origin's storage, each with its own quota, persistence and expiry.", typeof(StorageBucketsPage), ApiSupport.Chromium, ApiNeeds.SecureContext),
        ...
        [
            ...
            new("Crypto", "crypto", "SubtleCrypto encryption, hashing, signatures, key import/export, derivation and wrapping.", typeof(CryptoPage), ApiSupport.Broad, ApiNeeds.SecureContext),
            new("Fetch", "fetch", "The browser fetch API: a request/response/headers object model, progress and streamed uploads.", typeof(FetchPage)),
            ...
            new("OriginPrivateFileSystem", "origin-private-file-system", "A private, permissionless file system for the origin - with byte-offset reads and writes through a worker.", typeof(OriginPrivateFileSystemPage), ApiSupport.Broad, ApiNeeds.SecureContext),
