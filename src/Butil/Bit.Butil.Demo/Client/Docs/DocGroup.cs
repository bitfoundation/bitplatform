...
/// It is declared per group rather than per page on purpose: a hundred and five glyphs in one list is
/// decoration a reader has to look past to find a name, while twelve of them are landmarks that say
