...
/// <summary>
/// A process the suite starts and owns: its output is drained (a full pipe would stall it) into a bounded
/// buffer that failure messages quote, and disposing kills the whole process tree.
/// </summary>
