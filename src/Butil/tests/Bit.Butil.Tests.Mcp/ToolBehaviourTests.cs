...
public class ToolBehaviourTests : McpTestBase
{
    ...
    public async Task Api_list_is_the_shipped_public_surface()
    {
        ...
        using (Assert.Scope())
        {
            ...
            Assert.IsGreaterThan(100, types.Length, "Butil is more than a hundred services plus their option types and enums.");
    ...
    public async Task No_type_reference_exceeds_the_documented_cap()
    {
        ...
        // types are enormous - the extension classes are eighty or ninety members with their remarks - and one
