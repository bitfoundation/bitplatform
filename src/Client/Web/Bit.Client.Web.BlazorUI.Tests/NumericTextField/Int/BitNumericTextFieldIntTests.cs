...
namespace Bit.Client.Web.BlazorUI.Tests.NumericTextField.Int
{
    ...
    public class BitNumericTextFieldIntTests : BunitTestContext
    {
        ...
        {
            var component = RenderComponent<BitNumericTextFieldIntTest>(parameters =>
            {
        ...
        {
            var component = RenderComponent<BitNumericTextFieldIntTest>(parameters => parameters.Add(p => p.Suffix, suffix));
        ...
        {
            var component = RenderComponent<BitNumericTextFieldIntTest>();
        ...
        public void BitNumericTextFieldTwoWayBoundWithCustomHandlerShouldWorkCurrect(int value, int countOfIncrements, int step)
        {
        ...
        private int? Normalize(int? value, int precision) => value is null ? null : (int?)Math.Round((double)value.Value, precision);
