...
namespace Bit.Client.Web.BlazorUI.Playground.Web.Pages.Components.Modal
{
    public partial class BitModalDemo
    {
        ...
        private bool IsOpenInTopRight = false;
        private bool IsOpenInBottomLeft = false;
...
<BitButton OnClick=@(()=>IsOpenInTopRight=true)>Open Modal in the top and right position</BitButton>
<BitModal @bind-IsOpen=""IsOpenInTopRight"" Position=""BitModalPosition.TopRight"">
    <div class=""modal-header"">
        <span>Lorem Ipsum</span>
        <BitIconButton OnClick=@(()=>IsOpenInTopRight=false) IconName=""BitIconName.ChromeClose"" Title=""Close"" />
    </div>
    <div class=""modal-body"">
        <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas lorem nulla, malesuada ut sagittis sit
...
<BitButton OnClick=@(()=>IsOpenInBottomLeft=true)>Open Modal in the bottom and left position</BitButton>
<BitModal @bind-IsOpen=""IsOpenInBottomLeft"" Position=""BitModalPosition.BottomLeft"">
    <div class=""modal-header"">
        <span>Lorem Ipsum</span>
        <BitIconButton OnClick=@(()=>IsOpenInBottomLeft=false) IconName=""BitIconName.ChromeClose"" Title=""Close"" />
    </div>
    <div class=""modal-body"">
        <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas lorem nulla, malesuada ut sagittis sit
