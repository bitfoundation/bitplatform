...
<BitButton OnClick=@(()=>IsOpen=true)>Open Modal in the top and right position</BitButton>
<BitModal @bind-IsOpen=""IsOpen"" Position=""BitModalPosition.TopRight"">
    <div class=""modal-header"">
        <span>Lorem Ipsum</span>
        <BitIconButton OnClick=@(()=>IsOpen=false) IconName=""BitIconName.ChromeClose"" Title=""Close"" />
    </div>
    <div class=""modal-body"">
        ...
        private readonly string example1CSharpCode = @"private bool IsOpen = false;";
    }
}
