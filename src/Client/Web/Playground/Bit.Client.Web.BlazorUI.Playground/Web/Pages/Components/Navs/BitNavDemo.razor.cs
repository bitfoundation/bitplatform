...
namespace Bit.Client.Web.BlazorUI.Playground.Web.Pages.Components.Navs
{
    public partial class BitNavDemo
    {
        private readonly List<BitNavLinkItem> BasicNavLinks = new()
        {
                ...
                Links = new()
                {
                    new()
                    {
                        ...
                        Links = new()
                        {
                            ...
                            new() { Name = "MSN", Title = "MSN", Url = "http://msn.com", Key = "key1-1-2", Disabled = true }
                        }
                    },
                    new() { Name = "MSN", Title = "MSN", Url = "http://msn.com", Key = "key1-2", Disabled = true },
                }
            },
            ...
            new() { Name = "Notebook", Title = "Notebook", Url = "http://msn.com", Key = "key4", Disabled = true },
            new() { Name = "Communication and Media", Title = "Communication and Media", Url = "http://msn.com", Key = "key5", Target = "_top" },
            new() { Name = "News", Title = "News", Url = "http://msn.com", Key = "key6", Icon = "News", Target = "_self" },
        };
        ...
        private readonly List<BitNavLinkItem> BasicNoToolTipNavLinks = new()
        {
                ...
                Links = new List<BitNavLinkItem>
                {
                    new (){
                        ...
                        Links = new ()
                        {
                            ...
                            new () { Name = "MSN", Url = "http://msn.com", Key = "key1-1-2", Disabled = true }
                        }
                    },
                    new () { Name = "MSN", Url = "http://msn.com", Key = "key1-2", Disabled = true },
                }
            },
            ...
            new() { Name = "Notebook", Url = "http://msn.com", Key = "key4", Disabled = true },
                ...
                Links = new()
                {
                    new()
                    {
                        ...
                        Links = new()
                        {
                            ...
                            new() { Name = "3rd level link 2", Title = "3rd level link 2", Url = "http://msn.com", Key = "Key1-1-2", Disabled = true }
                        }
                    },
                    new() { Name = "Child link 2", Title = "Child link 2", Url = "http://msn.com", Key = "Key1-2" },
                    new() { Name = "Child link 3", Title = "Child link 3", Url = "http://msn.com", Key = "Key1-3", Disabled = true },
                }
            },
            new()
            {
