...
namespace Bit.View.Controls
{
    ...
    public partial class BitDateTimePopupView
    {
        public BitDateTimePopupView()
        {
            InitializeComponent();
        ...
        public static BindableProperty CultureProperty = BindableProperty.Create(nameof(Culture), typeof(CultureInfo), typeof(BitDateTimePopupView), defaultValue: CultureInfo.CurrentUICulture, defaultBindingMode: BindingMode.OneWay, propertyChanged: (sender, oldValue, newValue) =>
        {
            BitDateTimePopupView bitDateTimePopupView = (BitDateTimePopupView)sender;
            bitDateTimePopupView.CalcCurrentMonthDays();
        });
        ...
        {
            BitDateTimePopupView bitDateTimePopupView = (BitDateTimePopupView)sender;
            bitDateTimePopupView.SyncViewWithViewModel();
        });
    ...
    internal class DayOfWeekInfo : INotifyPropertyChanged
    {
        ...
        private string _DayOfWeekName = default!;
        /// <summary>
