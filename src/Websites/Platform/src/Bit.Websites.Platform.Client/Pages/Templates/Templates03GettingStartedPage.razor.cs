...
public partial class Templates03GettingStartedPage
{
    ...
    private Dictionary<CommandGroup, List<(string text, string command)>> commandGroups = new()
    {
        ...
        [
            ...
            command:"winget install Microsoft.DotNet.SDK.8 -v 9.0.100-preview.7.24407.12 --accept-source-agreements --accept-package-agreements;"),
            ...
            command:"dotnet new install Bit.Boilerplate::8.10.0;"),
        ],
