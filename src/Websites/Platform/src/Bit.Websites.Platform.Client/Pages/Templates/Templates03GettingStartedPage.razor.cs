...
public partial class Templates03GettingStartedPage
{
    ...
    private Dictionary<CommandGroup, List<(string text, string command)>> commandGroups = new()
    {
        [CommandGroup.Core] =
        [
            (text:@"REM Enable long paths files in Windows
REM https://learn.microsoft.com/en-us/windows/win32/fileio/maximum-file-path-limitation",
            command:@"reg add ""HKLM\SYSTEM\CurrentControlSet\Control\FileSystem"" /v LongPathsEnabled /t REG_DWORD /d 1 /f"),

            (text:@"REM Enable Windows developer mode
REM https://learn.microsoft.com/en-us/windows/apps/get-started/developer-mode-features-and-debugging#use-regedit-to-enable-your-device",
            ...
            (text:@"REM Install .NET SDK
REM https://dotnet.microsoft.com/en-us/download",
            command:"winget install Microsoft.DotNet.SDK.8 -v 8.0.303 --accept-source-agreements --accept-package-agreements"),

            (text:@"REM Install Node.js
REM https://nodejs.org/en/download/package-manager/all#windows-1",
            command:"winget install OpenJS.NodeJS --accept-source-agreements --accept-package-agreements"),

            (text:@"REM Install WebAssembly workloads
REM https://learn.microsoft.com/en-us/aspnet/core/blazor/webassembly-build-tools-and-aot#net-webassembly-build-tools",
            command:"\"%ProgramFiles%\\dotnet\\dotnet.exe\" workload install wasm-tools wasm-experimental"),

            (text:@"REM Install the Bit.Boilerplate project template
REM https://www.nuget.org/packages/Boilerplate.Templates",
            command:"\"%ProgramFiles%\\dotnet\\dotnet.exe\" new install Bit.Boilerplate::8.10.0-pre-03"),
        ],

        [CommandGroup.Additional] =
        [
            (text:@"REM Install MAUI workloads
REM https://learn.microsoft.com/en-us/dotnet/maui/get-started/installation?tabs=visual-studio-code#install-net-and-net-maui-workloads",
            command:"\"%ProgramFiles%\\dotnet\\dotnet.exe\" workload install maui")
        ],

        [CommandGroup.VS] =
        [
            (text:@"REM Install Visual Studio 2022 Community Edition
...
REM https://visualstudio.microsoft.com/downloads/",
        ...
        [CommandGroup.VSCode] =
        [
            (text:@"REM Install Visual Studio Code
REM https://code.visualstudio.com/download",
            ...
            (text:@"REM Install the C# Dev Kit extension for Visual Studio Code
REM https://marketplace.visualstudio.com/items?itemName=ms-dotnettools.csdevkit",
            command:"\"%LocalAppData%\\Programs\\Microsoft VS Code\\bin\\code.cmd\" --install-extension ms-dotnettools.csdevkit"),

            (text:@"REM Install the Blazor WASM Companion extension for Visual Studio Code
REM https://marketplace.visualstudio.com/items?itemName=ms-dotnettools.blazorwasm-companion",
            command:"\"%LocalAppData%\\Programs\\Microsoft VS Code\\bin\\code.cmd\" --install-extension ms-dotnettools.blazorwasm-companion"),

            (text:@"REM Install the Live Sass Compiler extension for Visual Studio Code
REM https://marketplace.visualstudio.com/items?itemName=glenn2223.live-sass",
            command:"\"%LocalAppData%\\Programs\\Microsoft VS Code\\bin\\code.cmd\" --install-extension glenn2223.live-sass"),

            (text:@"REM Install the ASP.NET Core Razor IntelliSense for Visual Studio Code
REM https://marketplace.visualstudio.com/items?itemName=kevin-chatham.aspnetcorerazor-html-css-class-completion",
            ...
            (text:@"REM Install the .NET MAUI extension for Visual Studio Code
REM https://marketplace.visualstudio.com/items?itemName=ms-dotnettools.dotnet-maui",
            command:"\"%LocalAppData%\\Programs\\Microsoft VS Code\\bin\\code.cmd\" --install-extension ms-dotnettools.dotnet-maui"),

            (text:@"REM Install the SQLite3 Editor extension for Visual Studio Code
REM https://marketplace.visualstudio.com/items?itemName=yy0931.vscode-sqlite3-editor",
            command:"\"%LocalAppData%\\Programs\\Microsoft VS Code\\bin\\code.cmd\" --install-extension yy0931.vscode-sqlite3-editor"),

            (text:@"REM Install the RESX Editor extension for Visual Studio Code
REM https://marketplace.visualstudio.com/items?itemName=DominicVonk.vscode-resx-editor",
