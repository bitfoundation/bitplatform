...
public static class Urls
{
    ...
    public const string TodoTemplateTestFlight = "https://testflight.apple.com/join/2qhcabSl";
    ...
    public const string AdminPanelTestFlight = "https://testflight.apple.com/join/vzGAk3n1";
