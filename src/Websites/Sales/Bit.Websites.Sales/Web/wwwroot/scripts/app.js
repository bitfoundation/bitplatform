...
window.onscroll = function () { return handleHeaderScroll(); };
...
function handleHeaderScroll() {
    ...
    if (document.body.scrollTop > 10 || document.documentElement.scrollTop > 10) {
        if (mainHeader.className.indexOf("header-shadow") < 0)
            mainHeader.className += " header-shadow";
    }
    else {
    ...
    if (currentUrlPath == "/process" || currentUrlPath == "/services" || currentUrlPath == "/about") {
        if (document.body.scrollTop > 10 || document.documentElement.scrollTop > 10) {
            ...
            if (mainHeader.className.indexOf("transparent-header") < 0)
                mainHeader.className += " transparent-header";
        }
    }
    if (currentUrlPath == "/") {
        if (document.body.scrollTop > 10 || document.documentElement.scrollTop > 10) {
            ...
            if (mainHeader.className.indexOf("home-page-header") < 0)
                mainHeader.className += " home-page-header";
        }
    }
}
