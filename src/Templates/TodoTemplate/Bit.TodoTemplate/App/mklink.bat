...
if not exist service-worker.js mklink /h "service-worker.js" "../../Web/wwwroot/service-worker.js"
if not exist service-worker.published.js mklink /h "service-worker.published.js" "../../Web/wwwroot/service-worker.published.js"