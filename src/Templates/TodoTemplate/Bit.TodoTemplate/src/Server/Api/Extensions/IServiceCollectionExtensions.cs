...
public static class IServiceCollectionExtensions
{
    ...
    public static void AddSwaggerGen(this IServiceCollection services)
    {
        ...
        {
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "TodoTemplate.Server.Api.xml"));
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "TodoTemplate.Shared.xml"));
