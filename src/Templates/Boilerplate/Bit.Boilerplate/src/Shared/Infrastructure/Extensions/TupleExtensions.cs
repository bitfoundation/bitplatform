...
///     {
///         categories = await HttpClient.GetJsonAsync("api/v1/categories"); // Took 150ms
///         products = await HttpClient.GetJsonAsync("api/v1/products"); // Took 150ms
...
///     protected override async Task OnInitAsync()
///     {
///         (categories, products) = await (HttpClient.GetJsonAsync("api/v1/categories"), HttpClient.GetJsonAsync("api/v1/products")); // Took 150ms
...
{
    extension<T1, T2>((Task<T1>, Task<T2>) tuple)
    {
        public TaskAwaiter<(T1, T2)> GetAwaiter()
        {
    ...
    extension<T1, T2, T3>((Task<T1>, Task<T2>, Task<T3>) tuple)
    {
        public TaskAwaiter<(T1, T2, T3)> GetAwaiter()
        {
    ...
    extension<T1, T2, T3, T4>((Task<T1>, Task<T2>, Task<T3>, Task<T4>) tuple)
    {
        public TaskAwaiter<(T1, T2, T3, T4)> GetAwaiter()
        {
    ...
    extension<T1, T2, T3, T4, T5>((Task<T1>, Task<T2>, Task<T3>, Task<T4>, Task<T5>) tuple)
    {
        public TaskAwaiter<(T1, T2, T3, T4, T5)> GetAwaiter()
        {
    ...
    extension<T1, T2, T3, T4, T5, T6>((Task<T1>, Task<T2>, Task<T3>, Task<T4>, Task<T5>, Task<T6>) tuple)
    {
        public TaskAwaiter<(T1, T2, T3, T4, T5, T6)> GetAwaiter()
        {
    ...
    extension<T1, T2, T3, T4, T5, T6, T7>((Task<T1>, Task<T2>, Task<T3>, Task<T4>, Task<T5>, Task<T6>, Task<T7>) tuple)
    {
        public TaskAwaiter<(T1, T2, T3, T4, T5, T6, T7)> GetAwaiter()
        {
