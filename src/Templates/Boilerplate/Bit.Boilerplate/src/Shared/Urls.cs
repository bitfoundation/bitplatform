...
public static partial class Urls
{
    ...
    public readonly static string[] AnonymousPages = [HomePage, NotAuthorizedPage, NotFoundPage,
        TermsPage, ConfirmPage, ForgotPasswordPage, 
        ResetPasswordPage, SignInPage, SignUpPage, 
        AboutPage];
}
