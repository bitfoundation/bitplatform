...
public partial class WebAuthnPasswordlessUITests : AppPageTest
{
    ...
    public async Task User_Should_EnablePasswordless_AndSignInWithPasskey()
    {
        ...
        // The code goes into the prompt's own BitOtpInput, addressed through the prompt (a BitModal, ".bit-md"):
        ...
        var elevatedAccessPrompt = Page.Locator(".bit-md").Filter(new() { HasText = AppStrings.EnterElevatedAccessToken });
