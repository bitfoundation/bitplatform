...
/// <summary>
/// OpenTelemetry processor that enriches telemetry data with Windows-specific context.
/// </summary>
public partial class WindowsTelemetryEnrichmentProcessor : BaseProcessor<Activity>
{
