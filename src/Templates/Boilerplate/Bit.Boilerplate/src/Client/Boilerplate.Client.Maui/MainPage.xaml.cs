...
public partial class MainPage
{
    ...
    {
        if (AppOperatingSystem.IsRunningOnAndroid) // We're using in app updates for android thanks to Oscore.Maui.Android.InAppUpdates
            return;
        ...
        catch (InvalidOperationException) when ((AppOperatingSystem.IsRunningOnIOS || AppOperatingSystem.IsRunningOnMacOS) && AppEnvironment.IsDev()) { }
