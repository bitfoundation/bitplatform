...
[IntentFilter([Intent.ActionView],
                        ...
                        DataPaths = ["/"],
                        DataPathPrefixes = [
                            Urls.ConfirmPage, Urls.ForgotPasswordPage, Urls.ProfilePage, Urls.ResetPasswordPage, Urls.SignInPage, Urls.SignUpPage, Urls.NotAuthorizedPage, Urls.NotFoundPage, Urls.AboutPage, Urls.TermsPage,
                            //#if (sample == "Admin")
