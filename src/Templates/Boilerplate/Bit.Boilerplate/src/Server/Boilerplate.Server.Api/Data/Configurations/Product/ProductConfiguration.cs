...
public partial class ProductConfiguration : IEntityTypeConfiguration<Product>
{
    public void Configure(EntityTypeBuilder<Product> builder)
    {
        ...
        {
            builder.Property(p => p.Embedding).HasColumnType("vector(384)"); // Dimensaions depends on the model used, here assuming 384 because of LocalTextEmbeddingGenerationService.
        }
        else
        {
