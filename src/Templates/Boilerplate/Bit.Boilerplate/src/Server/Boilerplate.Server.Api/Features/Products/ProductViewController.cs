...
{
    [HttpGet, EnableQuery(PageSize = 100), AppResponseCache(MaxAge = 60 * 5, UserAgnostic = true)]
    ...
    [EnableQuery(PageSize = 100), HttpGet("{id}"), AppResponseCache(MaxAge = 60 * 5, UserAgnostic = true)]
