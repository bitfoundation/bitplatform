...
public partial class InitialMigration : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.InsertData(
            ...
            values: new object[] { 1, 0, new DateTimeOffset(new DateTime(2023, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 1, 0, 0, 0)), "abc2cc9f-82d8-4d0f-8b30-bdf46771be8a", null, "test@bitplatform.dev", true, "Boilerplate test account", 2, false, null, "TEST@BITPLATFORM.DEV", "TEST@BITPLATFORM.DEV", "AQAAAAIAAYagAAAAEPoTVhWmCK6tZktIeSD0sVticLeZ1o2EVYZ9tUbY+PPr3tnJ/ZbSn7ZTBq6N+vl7UQ==", null, false, null, null, "bf6a9576-4c37-40bc-a4c2-7b42f3ec10cf", false, "test@bitplatform.dev" });
