...
<!-- Bridge stub. The canonical instructions live in .github/agents/localize-strings.agent.md
     (the file Visual Studio's agent picker reads). Edit the canonical file, not this one -
     only the frontmatter above needs to stay in sync. -->
