...
The tip above keeps a **single** container alive. To do the same for **all** of them (database, Keycloak, Redis, MailPit, storage and their management UIs) at once, there's a ready-made line at the bottom of `Program.cs` in the `Boilerplate.Server.AppHost` project — just uncomment it:
...
**If you spend a considerable amount of time on this project, uncommenting it is recommended.**
---
