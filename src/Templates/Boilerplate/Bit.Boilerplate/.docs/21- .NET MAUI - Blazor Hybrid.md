...
**Location**: [`/src/Client/Boilerplate.Client.Web/wwwroot/.well-known/apple-app-site-association`](/src/Client/Boilerplate.Client.Web/wwwroot/.well-known/apple-app-site-association)
