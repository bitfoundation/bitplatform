...
```xml
<PackageReference Include="Bit.BlazorUI" Version="10.1.1" />
```
...
```xml
<PackageVersion Include="Bit.BlazorUI" Version="10.1.1" />
```
...
```xml
<PackageVersion Include="Bit.BlazorUI" Version="10.1.1" />
<PackageVersion Include="Bit.Butil" Version="10.1.1" />
...
````markdown
This project gets generated by bit-bp template v-10.1.1 using the following command
```bash
dotnet new bit-bp
    --name Boilerplate
    --database SqlServer
