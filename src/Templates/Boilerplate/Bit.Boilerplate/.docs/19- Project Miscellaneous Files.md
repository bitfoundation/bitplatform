...
```xml
<PackageReference Include="Bit.BlazorUI" Version="10.4.4-pre-03" />
```
...
```xml
<PackageVersion Include="Bit.BlazorUI" Version="10.4.4-pre-03" />
```
...
```xml
<PackageVersion Include="Bit.BlazorUI" Version="10.4.4-pre-03" />
<PackageVersion Include="Bit.Butil" Version="10.4.4-pre-03" />
...
````markdown
This project gets generated by bit-bp template v-10.4.4-pre-03 using the following command
```bash
dotnet new bit-bp
    --name Boilerplate
    --database SqlServer
