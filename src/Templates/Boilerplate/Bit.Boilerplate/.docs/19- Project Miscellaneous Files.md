...
```xml
<PackageReference Include="Bit.BlazorUI" Version="11.0.0-pre-01" />
```
...
```xml
<PackageVersion Include="Bit.BlazorUI" Version="11.0.0-pre-01" />
```
...
```xml
<PackageVersion Include="Bit.BlazorUI" Version="11.0.0-pre-01" />
<PackageVersion Include="Bit.Butil" Version="11.0.0-pre-01" />
