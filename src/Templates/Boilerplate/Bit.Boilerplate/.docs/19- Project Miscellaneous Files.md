...
```xml
<PackageReference Include="Bit.BlazorUI" Version="10.5.0-pre-07" />
```
...
```xml
<PackageVersion Include="Bit.BlazorUI" Version="10.5.0-pre-07" />
```
...
```xml
<PackageVersion Include="Bit.BlazorUI" Version="10.5.0-pre-07" />
<PackageVersion Include="Bit.Butil" Version="10.5.0-pre-07" />
...
````markdown
This project gets generated by bit-bp template v-10.5.0-pre-07 using the following command
```bash
dotnet new bit-bp
    --name Boilerplate
    --database SqlServer
