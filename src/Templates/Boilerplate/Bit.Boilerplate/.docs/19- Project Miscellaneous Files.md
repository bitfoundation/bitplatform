...
```xml
<PackageVersion Include="Bit.BlazorUI" Version="10.4.5" />
```
...
```xml
<PackageVersion Include="Bit.BlazorUI" Version="10.4.5" />
<PackageVersion Include="Bit.Butil" Version="10.4.5" />
...
````markdown
This project gets generated by bit-bp template v-10.4.5 using the following command
```bash
dotnet new bit-bp
    --name Boilerplate
    --database SqlServer
