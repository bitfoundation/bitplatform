...
```xml
<PackageReference Include="Bit.BlazorUI" Version="10.2.1-pre-02" />
```
...
```xml
<PackageVersion Include="Bit.BlazorUI" Version="10.2.1-pre-02" />
```
...
```xml
<PackageVersion Include="Bit.BlazorUI" Version="10.2.1-pre-02" />
<PackageVersion Include="Bit.Butil" Version="10.2.1-pre-02" />
...
````markdown
This project gets generated by bit-bp template v-10.2.1-pre-02 using the following command
```bash
dotnet new bit-bp
    --name Boilerplate
    --database SqlServer
