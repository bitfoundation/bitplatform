...
```xml
<PackageReference Include="Bit.BlazorUI" Version="10.6.0-pre-06" />
```
...
```xml
<PackageVersion Include="Bit.BlazorUI" Version="10.6.0-pre-06" />
```
...
```xml
<PackageVersion Include="Bit.BlazorUI" Version="10.6.0-pre-06" />
<PackageVersion Include="Bit.Butil" Version="10.6.0-pre-06" />
...
````markdown
This project gets generated by bit-bp template v-10.6.0-pre-06 using the following command
```bash
dotnet new bit-bp
    --name Boilerplate
    --database SqlServer
