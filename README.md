...
[![Nuget downloads](https://img.shields.io/badge/packages_download-5.9M-blue.svg?logo=nuget)](https://www.nuget.org/profiles/bit-foundation)
...
| Sales | [![SPA](https://github-production-user-asset-6210df.s3.amazonaws.com/6169846/251395129-71a5a79c-af74-4d4e-a0f7-ed9a15cf2e46.png)](https://sales.bitplatform.dev) |
...
9. [sales.bitplatform.dev](https://sales.bitplatform.dev): .NET 9 Sales Pre-rendered SPA with Blazor WebAssembly (Azure Web App + Cloudflare CDN)
