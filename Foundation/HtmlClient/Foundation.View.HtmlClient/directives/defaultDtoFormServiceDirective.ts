module Foundation.View.Directives {
    ...
    export class DefaultDtoFormServiceDirective {
        ...
        public ngModel: ng.INgModelController & { $$parentForm: ViewModel.ViewModels.IDtoFormController };

        public constructor( @Core.Inject("$scope") public $scope: ng.IScope,
            @Core.Inject("$attrs") public $attrs: ng.IAttributes,
            @Core.Inject("$element") public $element: JQuery,
            @Core.Inject("$parse") public $parse: ng.IParseService,
            @Core.Inject("DateTimeService") public dateTimeService: ViewModel.Contracts.IDateTimeService,
            @Core.Inject("ClientAppProfileManager") public clientAppProfileManager: Core.ClientAppProfileManager) {

        }

        public dtoViewModel: ViewModel.ViewModels.DtoViewModel<Model.Contracts.IDto, ViewModel.Implementations.DtoRules<Model.Contracts.IDto>> = null;
        public dtoRules: ViewModel.Implementations.DtoRules<Model.Contracts.IDto> = null;
            ...
            this.$scope.$watch(this.$attrs.ngModel, (newModel: any, oldModel: any) => {
                ...
                if (this.$attrs.dtoViewModel != null) {
                    ...
                    if (tryToGetDtoViewModel instanceof ViewModel.ViewModels.DtoViewModel)
                        this.dtoViewModel = tryToGetDtoViewModel as ViewModel.ViewModels.DtoViewModel<Model.Contracts.IDto, ViewModel.Implementations.DtoRules<Model.Contracts.IDto>>;
                }
                ...
                if (this.dtoRules != null) {
                    ...
                    if (!(this.dtoRules instanceof ViewModel.Implementations.DtoRules)) {
                ...
                if (this.dtoViewModel != null) {
                    ...
                    if (!(this.dtoViewModel instanceof ViewModel.ViewModels.DtoViewModel)) {
                    ...
                    this.dtoViewModel.form = this.ngModel.$$parentForm as ViewModel.ViewModels.DtoFormController<Model.Contracts.IDto>;
