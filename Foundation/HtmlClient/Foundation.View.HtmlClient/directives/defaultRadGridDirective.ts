...
module Foundation.View.Directives {
    ...
    export class DefaultRadGridDirective {
        ...
        public constructor( @Core.Inject("$element") public $element: JQuery,
            ...
            @Core.Inject("$attrs") public $attrs: ng.IAttributes & { radDataSource: string, radOnInit: string },
            @Core.Inject("MetadataProvider") public metadataProvider: ViewModel.Contracts.IMetadataProvider,
            @Core.Inject("$translate") public $translate: ng.translate.ITranslateService,
            @Core.Inject("$parse") public $parse: ng.IParseService,
            @Core.Inject("$interpolate") public $interpolate: ng.IInterpolateService,
